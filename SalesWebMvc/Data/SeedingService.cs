...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Will Ferreira", "william@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Miss Lidia", "miss@gmail.com", new DateTime(1979, 12, 12), 3500.0, d2);
            Seller s3 = new Seller(3, "Paulo", "paulo@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            Seller s4 = new Seller(4, "Bob", "bob@gmail.com", new DateTime(1993, 11, 30), 3000.0, d4);
            Seller s5 = new Seller(5, "Sponja", "Sponj@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
            Seller s6 = new Seller(6, "Molusco", "molusco@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
